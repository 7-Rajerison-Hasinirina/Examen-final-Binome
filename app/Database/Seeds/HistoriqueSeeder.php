...
class HistoriqueSeeder extends Seeder
{
    public function run()
    {
        ...
        $data = [
            ['id_user' => 2, 'id_operation' => 1, 'valeur' => 5000.00, 'numero_destination' => '1111112', 'reference' => 'Dépôt initial', 'sens' => 'entree'],
            ['id_user' => 2, 'id_operation' => 1, 'valeur' => 10000.00, 'numero_destination' => '2222222', 'reference' => 'Dépôt initial', 'sens' => 'entree'],
            ...
            ['id_user' => 2, 'id_operation' => 2, 'valeur' => 5000.00, 'numero_source' => '1111112', 'reference' => 'Retrait guichet', 'sens' => 'sortie'],
            ['id_user' => 2, 'id_operation' => 2, 'valeur' => 2500.00, 'numero_source' => '2222222', 'reference' => 'Retrait guichet', 'sens' => 'sortie'],
            ['id_user' => 3, 'id_operation' => 1, 'valeur' => 15000.00, 'numero_destination' => '1234567', 'reference' => 'Dépôt initial', 'sens' => 'entree'],
            ...
            ['id_user' => 2, 'id_operation' => 1, 'valeur' => 20000.00, 'numero_destination' => '1111112', 'reference' => 'Dépôt bonus', 'sens' => 'entree'],
        ];
